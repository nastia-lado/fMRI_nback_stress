...
#nback_power_1 = np.load(f'{top_dir}/func_connect/02-extracted_timeseries/nback/LB_nback_timeseries_power_denoised_acompcor_smooth_run-1.npy', allow_pickle=True)
nback_ho_cort_1 = np.load(f'{top_dir}/func_connect/02-extracted_timeseries/nback/LB_nback_timeseries_harvard-oxford_cort_denoised_acompcor_smooth_run-1.npy', allow_pickle=True)
nback_ho_sub_1 = np.load(f'{top_dir}/func_connect/02-extracted_timeseries/nback/LB_nback_timeseries_harvard-oxford_sub_denoised_acompcor_smooth_run-1.npy', allow_pickle=True)
nback_ho_1 = np.concatenate((nback_ho_cort_1, nback_ho_sub_1), axis=3)
nback_talairach_1 = np.load(f'{top_dir}/func_connect/02-extracted_timeseries/nback/LB_nback_timeseries_talairach_denoised_acompcor_smooth_run-1.npy', allow_pickle=True)
nback_aal_1 = np.load(f'{top_dir}/func_connect/02-extracted_timeseries/nback/LB_nback_timeseries_aal_denoised_acompcor_smooth_run-1.npy', allow_pickle=True)
#nback_craddock_1 = np.load(f'{top_dir}/func_connect/02-extracted_timeseries/nback/LB_nback_timeseries_craddock_denoised_acompcor_smooth_run-1.npy', allow_pickle=True)
...
nback_1 = np.asarray([
                    ...
                    [nback_aal_1, 'nback_aal']
                    #[nback_craddock_1, 'nback_craddock']
                    ])

#nback_power_2 = np.load(f'{top_dir}/func_connect/02-extracted_timeseries/nback/LB_nback_timeseries_power_denoised_acompcor_smooth_run-2.npy', allow_pickle=True)
nback_ho_cort_2 = np.load(f'{top_dir}/func_connect/02-extracted_timeseries/nback/LB_nback_timeseries_harvard-oxford_cort_denoised_acompcor_smooth_run-2.npy', allow_pickle=True)
nback_ho_sub_2 = np.load(f'{top_dir}/func_connect/02-extracted_timeseries/nback/LB_nback_timeseries_harvard-oxford_sub_denoised_acompcor_smooth_run-2.npy', allow_pickle=True)
nback_ho_2 = np.concatenate((nback_ho_cort_2, nback_ho_sub_2), axis=3)
nback_talairach_2 = np.load(f'{top_dir}/func_connect/02-extracted_timeseries/nback/LB_nback_timeseries_talairach_denoised_acompcor_smooth_run-2.npy', allow_pickle=True)
nback_aal_2 = np.load(f'{top_dir}/func_connect/02-extracted_timeseries/nback/LB_nback_timeseries_aal_denoised_acompcor_smooth_run-2.npy', allow_pickle=True)
#nback_craddock_2 = np.load(f'{top_dir}/func_connect/02-extracted_timeseries/nback/LB_nback_timeseries_craddock_denoised_acompcor_smooth_run-2.npy', allow_pickle=True)
...
for p in range(nback_1.shape[0]):
    ...
    for a, sub in enumerate(subs):
        ...
        for b, ses in enumerate(sess):
            ...
            events_dir = f'{top_dir}/preprocessed/derivatives/fmriprep/{sub}/{ses}/func/'
